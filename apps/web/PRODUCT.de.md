...
- Portable verwaltet ein servergeführtes Dossier und erzeugt Findings-only-Berichtsseiten mit jeweils höchstens 16 bestätigten Kandidaten. Diese internen, privaten Seiten werden validiert und zu einem einzigen Abschlussbericht zusammengeführt; abgelehnte Kandidaten und ihre Abdeckung werden vom Server abgeleitet. Unter dem maximalen Envelope werden bis zu 32 Seiten und 512 normalisierte Findings unterstützt. Schlägt eine Seite, ihre Coverage, ihre Anker oder die abschließende Normalisierung fehl, wird kein partieller Abschlussbericht veröffentlicht.
- Portable Deep ermittelt und partitioniert eigenständig die prüfbaren Quellcode- und Sicherheitskonfigurationsdateien des unveränderlichen Snapshots. Discovery endet erst, wenn jede zugewiesene Datei vollständig gelesen wurde; sie hängt niemals von einem Standard-Lauf ab und veröffentlicht keine partielle Deep-Abdeckung. Alle Deep-Effort-Gruppen teilen ein globales 90-Minuten-Deadline; Turn- und Tool-Envelopes skalieren von 48/384 bis 128/1.024.
