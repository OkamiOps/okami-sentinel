...
export function SettingsPage() {
  ...
  return <div>
    ...
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1.3fr)_minmax(18rem,.7fr)]">
      <Panel label="ENGINE MATRIX" title={t("settings.runtime")}>
      ...
      <Panel label="CAPACITY" title={t("settings.envelope")}>
