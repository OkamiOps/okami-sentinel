...
- Portable-Phasenartefakte und private Berichtsseiten sind nicht vertrauenswürdige Eingaben. Bevor ein Artefaktschreibvorgang akzeptiert wird, validiert der Server einen strikten Vertrag und die angehefteten Snapshot-Anker. Ein abgelehntes Artefakt erhält nur ein begrenztes Reparaturfenster innerhalb der bestehenden globalen Grenzen des Scans für Turns, Tools, Zeit und konfigurierte Kosten.
- Der Server leitet die Abdeckung abgelehnter Kandidaten ab, hält Berichtsseiten privat und schreibt erst dann einen einzigen Abschlussbericht, wenn alle Seiten validiert und zusammengeführt sind. Eine fehlgeschlagene Seite oder Reparatur veröffentlicht niemals einen partiellen Abschlussbericht.
- Die öffentliche Portable-Normalisierungsgrenze berücksichtigt den gesamten Bericht: Sie akzeptiert höchstens 512 Findings, 20 Anker pro Finding und eine kanonische Ausgabe von 4 MiB. Öffentliche Texte und Belege durchlaufen die Redaction; Grenzverletzungen führen fail-closed zum Abbruch, statt den Bericht still abzuschneiden.
